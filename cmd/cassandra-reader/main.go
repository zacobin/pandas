...
const (
	...
	envLogLevel      = "PD_CASSANDRA_READER_LOG_LEVEL"
	envPort          = "PD_CASSANDRA_READER_PORT"
	envCluster       = "PD_CASSANDRA_READER_DB_CLUSTER"
	envKeyspace      = "PD_CASSANDRA_READER_DB_KEYSPACE"
	envDBUsername    = "PD_CASSANDRA_READER_DB_USERNAME"
	envDBPassword    = "PD_CASSANDRA_READER_DB_PASSWORD"
	envDBPort        = "PD_CASSANDRA_READER_DB_PORT"
	envThingsURL     = "PD_THINGS_URL"
	envClientTLS     = "PD_CASSANDRA_READER_CLIENT_TLS"
	envCACerts       = "PD_CASSANDRA_READER_CA_CERTS"
	envServerCert    = "PD_CASSANDRA_READER_SERVER_CERT"
	envServerKey     = "PD_CASSANDRA_READER_SERVER_KEY"
	envJaegerURL     = "PD_JAEGER_URL"
	envThingsTimeout = "PD_CASSANDRA_READER_THINGS_TIMEOUT"
)

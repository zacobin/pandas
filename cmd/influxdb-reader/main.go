...
const (
	...
	envLogLevel      = "PD_INFLUX_READER_LOG_LEVEL"
	envPort          = "PD_INFLUX_READER_PORT"
	envDBName        = "PD_INFLUX_READER_DB_NAME"
	envDBHost        = "PD_INFLUX_READER_DB_HOST"
	envDBPort        = "PD_INFLUX_READER_DB_PORT"
	envDBUser        = "PD_INFLUX_READER_DB_USER"
	envDBPass        = "PD_INFLUX_READER_DB_PASS"
	envClientTLS     = "PD_INFLUX_READER_CLIENT_TLS"
	envCACerts       = "PD_INFLUX_READER_CA_CERTS"
	envServerCert    = "PD_INFLUX_READER_SERVER_CERT"
	envServerKey     = "PD_INFLUX_READER_SERVER_KEY"
	envJaegerURL     = "PD_JAEGER_URL"
	envThingsTimeout = "PD_INFLUX_READER_THINGS_TIMEOUT"
)

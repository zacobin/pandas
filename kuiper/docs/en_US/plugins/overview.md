...
Kuiper has many built-in functions that can perform calculations on data. (Refer to https://github.com/cloustone/pandas/kuiper/blob/master/docs/zh_CN/sqls/built-in_functions.md for specific documentation)

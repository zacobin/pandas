...
- Refer to [EdgeX Kuiper Rule Engine Tutorial](https://github.com/cloustone/pandas/kuiper/blob/master/docs/en_US/edgex/edgex_rule_engine_tutorial.md):  You'd better go through this quick tutorial,  and get to start trying out the rules engine in the EdgeX. 
...
Make sure you have followed document [EdgeX Kuiper Rule Engine Tutorial](https://github.com/cloustone/pandas/kuiper/blob/master/docs/en_US/edgex/edgex_rule_engine_tutorial.md), and successfully run the tutorial. 

### Create EdgeX stream

You should create a stream that can consume streaming data from EdgeX application service before creating rule. This step is not required if you already finished [EdgeX Kuiper Rule Engine Tutorial](https://github.com/cloustone/pandas/kuiper/blob/master/docs/en_US/edgex/edgex_rule_engine_tutorial.md). 
...
- [Kuiper Github code repository](https://github.com/cloustone/pandas/kuiper/)
- [Kuiper reference guide](https://github.com/cloustone/pandas/kuiper/blob/edgex/docs/en_US/reference.md)

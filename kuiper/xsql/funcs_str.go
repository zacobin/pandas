...
func strCall(name string, args []interface{}) (interface{}, bool) {
	...
	case "concat":
		...
		for _, arg := range args {
			b.WriteString(util.ToString(arg))
		}
		return b.String(), true
	case "endswith":
		arg0, arg1 := util.ToString(args[0]), util.ToString(args[1])
		return strings.HasSuffix(arg0, arg1), true
	case "indexof":
		arg0, arg1 := util.ToString(args[0]), util.ToString(args[1])
		return strings.Index(arg0, arg1), true
	case "length":
		arg0 := util.ToString(args[0])
	...
	case "format_time":
		...
		if t, ok := arg0.(time.Time); ok {
			arg1 := util.ToString(args[1])
			if s, err := util.FormatTime(t, arg1); err == nil {
				return s, true
			}
		}
		return "", false
	...
	case "regexp_replace":
		arg0, arg1, arg2 := util.ToString(args[0]), util.ToString(args[1]), util.ToString(args[2])

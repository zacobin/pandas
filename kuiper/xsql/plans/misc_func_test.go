...
func TestMiscFunc_Apply1(t *testing.T) {
	...
	contextLogger := util.Log.WithField("rule", "TestMiscFunc_Apply1")
...
func TestMqttFunc_Apply2(t *testing.T) {
	...
	fmt.Printf("The test bucket size is %d.\n\n", len(tests))
	contextLogger := util.Log.WithField("rule", "TestMqttFunc_Apply2")
	ctx := contexts.WithValue(contexts.Background(), contexts.LoggerKey, contextLogger)
	for i, tt := range tests {
		stmt, err := xsql.NewParser(strings.NewReader(tt.sql)).Parse()
		if err != nil || stmt == nil {
...
func TestMetaFunc_Apply1(t *testing.T) {
	...
	fmt.Printf("The test bucket size is %d.\n\n", len(tests))
	contextLogger := util.Log.WithField("rule", "TestMetaFunc_Apply1")
	ctx := contexts.WithValue(contexts.Background(), contexts.LoggerKey, contextLogger)
	for i, tt := range tests {
		stmt, err := xsql.NewParser(strings.NewReader(tt.sql)).Parse()
		if err != nil || stmt == nil {
...
func TestJsonPathFunc_Apply1(t *testing.T) {
	...
	fmt.Printf("The test bucket size is %d.\n\n", len(tests))
	contextLogger := util.Log.WithField("rule", "TestJsonFunc_Apply1")
	ctx := contexts.WithValue(contexts.Background(), contexts.LoggerKey, contextLogger)
	for i, tt := range tests {
		stmt, err := xsql.NewParser(strings.NewReader(tt.sql)).Parse()
		if err != nil || stmt == nil {

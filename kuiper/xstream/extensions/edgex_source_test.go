...
func TestGetValue_IntFloat(t *testing.T) {
	...
	for _, r := range testEvent.Readings {
		if v, e := es.getValue(r, util.Log); e != nil {
			t.Errorf("%s", e)
		} else {
			expectOne(t, v)
		}
	...
	if v, e := es.getValue(rf_01, util.Log); e != nil {
		t.Errorf("%s", e)
	} else {
	...
	if v, e := es.getValue(rf_02, util.Log); e != nil {
		t.Errorf("%s", e)
	} else {
		if v1, ok := v.(float64); ok {
			if v1 != 3.14 {
	...
	if v, e := es.getValue(r1, util.Log); e != nil {
		t.Errorf("%s", e)
	} else {
	...
	if v, e := es.getValue(r2, util.Log); e != nil {
		t.Errorf("%s", e)
	} else {
		if v1, ok := v.(float64); ok {
			if v1 != 3.14 {
...
func TestGetValue_IntFloatArr(t *testing.T) {
	...
	if v, e := es.getValue(rf_00, util.Log); e != nil {
		t.Errorf("%s", e)
	} else {
		if v1, ok := v.([]float64); ok {
...
func TestGetValue_Bool(t *testing.T) {
	...
	if _, e := es.getValue(r1, util.Log); e == nil {
		t.Errorf("%s", e)
	}
...
func TestWrongType(t *testing.T) {
	...
	if v, _ := es1.getValue(r1, util.Log); v != "100" {
...
func TestWrongValue(t *testing.T) {
	...
	for _, v := range testEvent.Readings {
		if _, e := es.getValue(v, util.Log); e == nil {

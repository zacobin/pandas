...
import (
	...
	nats "github.com/cloustone/pandas/vms/nats/publisher"
...
func (v2m *vmService) AddView(ctx context.Context, token string, view View) (tw View, err error) {
	var id string
	var b []byte
...
func (v2m *vmService) UpdateView(ctx context.Context, token string, view View) (err error) {
	var b []byte
	var id string
...
func (v2m *vmService) ViewView(ctx context.Context, token, id string) (tw View, err error) {
	var b []byte
...
func (v2m *vmService) RemoveView(ctx context.Context, token, id string) (err error) {
	var b []byte
...
func (v2m *vmService) ListViews(ctx context.Context, token string, offset uint64, limit uint64, name string, metadata Metadata) (ViewsPage, error) {
	res, err := v2m.auth.Identify(ctx, &mainflux.Token{Value: token})
	if err != nil {
...
func (v2m *vmService) AddVariable(ctx context.Context, token string, variable Variable) (v Variable, err error) {
	var id string
	var b []byte
	defer v2m.nats.Publish(&id, &err, crudOp["createSucc"], crudOp["createFail"], &b)
...
func (v2m *vmService) UpdateVariable(ctx context.Context, token string, variable Variable) (err error) {
	var b []byte
	var id string
	defer v2m.nats.Publish(&id, &err, crudOp["updateSucc"], crudOp["updateFail"], &b)
...
func (v2m *vmService) ViewVariable(ctx context.Context, token, id string) (tv Variable, err error) {
	var b []byte
	defer v2m.nats.Publish(&id, &err, crudOp["getSucc"], crudOp["getFail"], &b)
...
func (v2m *vmService) RemoveVariable(ctx context.Context, token, id string) (err error) {
	var b []byte
	defer v2m.nats.Publish(&id, &err, crudOp["removeSucc"], crudOp["removeFail"], &b)
...
func (v2m *vmService) ListVariables(ctx context.Context, token string, offset uint64, limit uint64, name string, metadata Metadata) (VariablesPage, error) {
	res, err := v2m.auth.Identify(ctx, &mainflux.Token{Value: token})
	if err != nil {
...
func (v2m *vmService) SaveStates(msg *mainflux.Message) error {
...
func (v2m *vmService) saveState(msg *mainflux.Message, variable Variable) error {
...
func (v2m *vmService) updateVariable(variable Variable, model Model, rec senml.Record, msg *mainflux.Message) (Variable, error) {
...
func (v2m *vmService) AddModel(ctx context.Context, token string, model Model) (v Model, err error) {
	var id string
	var b []byte
	defer v2m.nats.Publish(&id, &err, crudOp["createSucc"], crudOp["createFail"], &b)
...
func (v2m *vmService) UpdateModel(ctx context.Context, token string, model Model) (err error) {
	var b []byte
	var id string
	defer v2m.nats.Publish(&id, &err, crudOp["updateSucc"], crudOp["updateFail"], &b)
...
func (v2m *vmService) ViewModel(ctx context.Context, token, id string) (tm Model, err error) {
	var b []byte
	defer v2m.nats.Publish(&id, &err, crudOp["getSucc"], crudOp["getFail"], &b)
...
func (v2m *vmService) RemoveModel(ctx context.Context, token, id string) (err error) {
	var b []byte
	defer v2m.nats.Publish(&id, &err, crudOp["removeSucc"], crudOp["removeFail"], &b)
...
func (v2m *vmService) ListModels(ctx context.Context, token string, offset uint64, limit uint64, name string, metadata Metadata) (ModelsPage, error) {
	res, err := v2m.auth.Identify(ctx, &mainflux.Token{Value: token})
	if err != nil {

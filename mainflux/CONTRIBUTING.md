...
list](https://github.com/cloustone/pandas/mainflux/issues) to determine if it already contains the
...
cd mainflux
git remote add upstream https://github.com/cloustone/pandas/mainflux.git
```

...
func createCircleGeofenceEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.CreateCircleGeofence(ctx, req.token, fence)
		if err != nil {
			return nil, err
		}
...
func updateCircleGeofenceEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.UpdateCircleGeofence(ctx, req.token, fence)
		if err != nil {
...
func deleteGeofenceEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.DeleteGeofence(ctx, req.token, req.fenceIDs, req.objects)
		if err != nil {
...
func listGeofencesEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.ListGeofences(ctx, req.token, req.fenceIDs, req.objects)
		if err != nil {
			return nil, err
		}
...
func addMonitoredObjectEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.AddMonitoredObject(ctx, req.token, req.fenceID, req.objects)
		if err != nil {
			return nil, err
		}
		return nil, nil
...
func removeMonitoredObjectEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.RemoveMonitoredObject(ctx, req.token, req.fenceID, req.objects)
		if err != nil {
			return nil, err
		}
		return nil, nil
...
func listMonitoredObjectsEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		t, o, err := svc.ListMonitoredObjects(ctx, req.token, req.fenceID, req.pageIndex, req.pageSize)
		if err != nil {
			return nil, err
		}
...
func createPolyGeofenceEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.CreatePolyGeofence(ctx, req.token, fence)
		if err != nil {
			return nil, err
		}
...
func updatePolyGeofenceEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.UpdatePolyGeofence(ctx, req.token, fence)
		if err != nil {
			return nil, err
		}
		return nil, nil
...
func getFenceIDsEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.GetFenceIDs(ctx, req.token)
		if err != nil {
			return nil, err
		}
		res := getFenceIDsRes{
...
func queryStatusEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.QueryStatus(ctx, req.token, req.monitoredPerson, req.fenceIDs)
		if err != nil {
			return nil, err
		}
		res := queryStatusRes{
...
func getHistoryAlarmsEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.GetHistoryAlarms(ctx, req.token, req.monitoredPerson, req.fenceIDs)
		if err != nil {
			return nil, err
		}
...
func batchGetHistoryAlarmsEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.BatchGetHistoryAlarms(ctx, req.token, tmp)
		if err != nil {
			return nil, err
		}
...
func getStayPointsEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		saved, err := svc.GetStayPoints(ctx, req.token, tmp)
		if err != nil {
			return nil, err
		}
...
func notifyAlarmsEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.NotifyAlarms(ctx, req.token, req.content)
		if err != nil {
			return nil, err
		}
...
func addEntityEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.AddEntity(ctx, req.token, req.entityName, req.entityDesc)
		if err != nil {
			return nil, err
		}
		res := addEntityRes{
...
func deleteEntityEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.DeleteEntity(ctx, req.token, req.entityName)
		if err != nil {
			return nil, err
		}
		res := deleteEntityRes{
...
func updateEntityEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.UpdateEntity(ctx, req.token, req.entityName, req.entityDesc)
		if err != nil {
			return nil, err
		}
		res := updateEntityRes{
...
func listEntityEndpoint(svc lbs.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		total, saved, err := svc.ListEntity(ctx, req.token, req.coordTypeOutput, req.pageIndex, req.pageSize)
		if err != nil {
			return nil, err
		}
		res := listEntityRes{

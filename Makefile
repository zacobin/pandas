...
SERVICES = rulechain lbs authn authz things bootstrap twins users vms realms swagger
...
IMAGES = rulechain lbs authn authz things bootstrap twins users vms realms swagger

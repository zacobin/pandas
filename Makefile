...
SERVICES = rulechain lbs authn authz things bootstrap twins users v2ms realms headmast swagger-helper
...
IMAGES = rulechain lbs authn authz things bootstrap twins users v2ms realms headmast swagger-helper
